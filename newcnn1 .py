...
def read_dataset(path):
    ...
    for pa in my_list:
        ...
        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'C:\Users\abhis\MCA S4\Project\Dataset\Train\\' + pa):
...
# load dataset
x_dataset, y_dataset = read_dataset(r"D:\vehicle classification with deep learning\src\dataset")
...
if not os.path.exists("model123.h5"):
